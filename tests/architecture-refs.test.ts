...
const SRC_MODULES = [
	...
	"src/hooks-research.ts",
	"src/hooks-research-group.ts",
	"src/hooks-discussing.ts",
	"src/hooks-executing.ts",
	"src/hooks-verifying.ts",
...
const REFERENCE_TABLE: RefEntry[] = [
	...
	// ---- trigger-resolution ------------------------------------------------
	{ id: "TR-RESOLVE", page: "trigger-resolution", file: "trigger-resolver.ts", symbol: "resolveTrigger", kind: "callable", lines: [178, 178] },
	{
		id: "TR-OUTPUT-IFACE",
